hyperparams = {
    ...
    'n_multisteps':        10,      # number of steps to consider for multistep learning
    'v_min':               -5,      # minimum support value for distributional learning
    'v_max':               5,       # maximum support value for distributional learning
