hyperparams = {
    ...
    'n_multisteps':        4,      # number of steps to consider for multistep learning
    'v_min':               -1,      # minimum support value for distributional learning
    'v_max':               1,       # maximum support value for distributional learning
