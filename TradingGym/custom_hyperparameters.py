hyperparams = {
    ...
    'buffer_size':         1000000, # size of the experience replay buffer
    'batch_size':          128,     # number of experiences to sample at each learning step
    ...
    'v_min':               -0.4,      # minimum support value for distributional learning
    'v_max':               0.4,       # maximum support value for distributional learning
