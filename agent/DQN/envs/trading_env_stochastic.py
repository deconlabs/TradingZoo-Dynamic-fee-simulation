...
class TradingEnv:
    ...
    def reset(self):  # prepares various state components
        ...
        # observation part
        self.previous_stoch = get_stochastic(self.df_sample.iloc[self.step_st: self.step_st + self.obs_len])
    ...
    def step(self, action):
        ...
        present_stoch=get_stochastic(self.df_sample.iloc[self.step_st: self.step_st + self.obs_len])

        self.fee_rate=np.clip(self.fee_rate*present_stoch/self.previous_stoch,self.min_fee_rate,self.max_fee_rate)
