...
# do
#     tmux new-session -s $i-0 -d "/home/jeffrey/anaconda3/envs/RL/bin/python transfer_learning.py --device_num=$((i%4)) --save_num=$i --risk_aversion=$i --n_episodes=402 --fee=.0; read"
# done
